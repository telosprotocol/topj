...
public class SenderAction {
    ...
    public byte[] serialize_write(){
        ...
        bufferUtils.BigIntToBytes(actionHash, 32)
                ...
                .stringToBytes(txSenderAccountAddr)
    ...
    public String getTxSenderAccountAddr() {
        return txSenderAccountAddr;
    }

    public void setTxSenderAccountAddr(String txSenderAccountAddr) {
        this.txSenderAccountAddr = txSenderAccountAddr;
    }
